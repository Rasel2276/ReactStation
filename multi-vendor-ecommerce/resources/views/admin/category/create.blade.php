...
<div class="form-wrapper">
    ...
    <form action="{{ route('categories.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="form-row">
            ...
            <input type="text" id="name" name="name" value="{{ old('name') }}" placeholder="Enter category name" required>
        </div>

        <div class="form-row">
            <label for="slug">Slug:</label>
            <input type="text" id="slug" name="slug" value="{{ old('slug') }}" placeholder="auto or manual slug">
        </div>
        ...
        <a href="{{ route('categories.index') }}" style="margin-left:15px; text-decoration:none; color:#4b6cb7;">Cancel</a>
    </form>
</div>
