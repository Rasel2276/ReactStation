		...
		<nav id="sidebar" class="sidebar js-sidebar">
          ...
          <span class="align-middle">Admin Dashboard</span>
              ...
              <i class="align-middle" data-feather="list"></i> <span class="align-middle">Manage Sub Category</span>
					...
					<li class="sidebar-item {{request()->routeIs('product_attribute.create_attribute')?'active':''}}">
						<a class="sidebar-link" href="{{route('product_attribute.create_attribute')}}">
              <i class="align-middle" data-feather="plus"></i> <span class="align-middle">Create Attribute</span>
            </a>
					</li>

					<li class="sidebar-item {{request()->routeIs('product_attribute.manage_attribute')?'active':''}}">
						<a class="sidebar-link" href="{{route('product_attribute.manage_attribute')}}">
              <i class="align-middle" data-feather="list"></i> <span class="align-middle">Manage Attribute</span>
					...
					<li class="sidebar-item {{request()->routeIs('inventory.add_suplier')?'active':''}}">
						<a class="sidebar-link" href="{{route('inventory.add_suplier')}}">
              <i class="align-middle" data-feather="plus"></i> <span class="align-middle">Add Suplier</span>
            </a>
					</li>
              ...
              <i class="align-middle" data-feather="list"></i> <span class="align-middle">Return Records</span>
					...
					<li class="sidebar-item {{request()->routeIs('inventory.product')?'active':''}}">
						<a class="sidebar-link" href="{{route('inventory.product')}}">
              <i class="align-middle" data-feather="list"></i> <span class="align-middle">Products</span>
            </a>
					</li>

					<li class="sidebar-item {{request()->routeIs('inventory.product_records')?'active':''}}">
						<a class="sidebar-link" href="{{route('inventory.product_records')}}">
              <i class="align-middle" data-feather="list"></i> <span class="align-middle">Product Records</span>
            </a>
					</li>
              ...
              <i class="align-middle" data-feather="shopping-cart"></i> <span class="align-middle">Total Income</span>
					...
					<li class="sidebar-item {{request()->routeIs('admin.order.order_history')?'active':''}}">
						<a class="sidebar-link" href="{{route('admin.order.order_history')}}">
