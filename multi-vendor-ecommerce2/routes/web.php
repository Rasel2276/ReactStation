...
Route::middleware(['auth', 'verified','rolemanager:admin'])->group(function () {
    ...
    Route::controller(ProductController::class)->group(function(){
        ...
        Route::post('product/purchase-requests/{purchase}/accept', 'acceptPurchase')->name('admin.product.purchase_request.accept');
        Route::post('product/purchase-requests/{purchase}/reject', 'rejectPurchase')->name('admin.product.purchase_request.reject');
    });
...
Route::get('/dashboard','index')->name('vendor');
    ...
    Route::controller(InventoryController::class)->group(function(){
        ...
        Route::post('inventory/purchase-return/store', 'store_purchase_return')->name('inventory.vendor_purchase_return_store');
        Route::get('inventory/vendor_return_record', 'vendor_return_record')->name('inventory.vendor_return_record');
        Route::delete('inventory/vendor_return_record/delete/{id}', 'delete_vendor_return')->name('inventory.vendor_return_record_delete');
        Route::get('inventory/manage-stock', 'manage_stock')->name('inventory.manage_stock');
        Route::delete('inventory/manage-stock/delete/{id}', 'delete_manage_stock')->name('inventory.delete_manage_stock');
        Route::get('inventory/admin-product-list', 'admin_product_list')->name('inventory.admin_product_list');
        Route::get('inventory/my_stock', 'my_stock')->name('inventory.my_stock');
        Route::delete('inventory/my_stock/delete/{id}', 'delete_stock')->name('inventory.delete_stock');
